...
namespace Baybakov_Glazki
{
    ...
    public partial class BaybakovGlazkiSaveEntities : DbContext
    {
        private static BaybakovGlazkiSaveEntities _context;

        public static BaybakovGlazkiSaveEntities GetContext()
        {
            if (_context == null)
                _context = new BaybakovGlazkiSaveEntities();

            return _context;
        }

        public BaybakovGlazkiSaveEntities()
            : base("name=BaybakovGlazkiSaveEntities")
        {
        }
